...
# set_property -dict {PACKAGE_PIN AJ6  IOSTANDARD LVCMOS18} [get_ports gp_clk_a]                  ; ## D08 FMC_HPC1_LA01_CC_P
...
# not used in RGMII mode
# set_property -dict {PACKAGE_PIN Y5   IOSTANDARD LVCMOS18} [get_ports gp_clk_b]                  ; ## D20 FMC_HPC1_LA17_CC_P
...
# create_clock -name mdc_fmc_a      -period  400.0 [get_pins i_system_wrapper/system_i/sys_ps8/inst/PS8_i/EMIOENET0MDIOMDC]
# create_clock -name mdc_fmc_b      -period  400.0 [get_pins i_system_wrapper/system_i/sys_ps8/inst/PS8_i/EMIOENET1MDIOMDC]

set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets i_system_wrapper/system_i/gmii_to_rgmii_1/U0/rgmii_rxc_ibuf_i/O]
