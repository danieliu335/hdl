...
module system_top (
  ...
  assign led_ar_c_c2m = led_0_a; // yellow only
  assign led_ar_a_c2m = 1'b1;

  // port a - left led (speed mode): 10M=off, 100M=yellow, 1G=green

  assign led_al_c_c2m = loopback_phy_mac_speed_0[1];
  assign led_al_a_c2m = loopback_phy_mac_speed_0[0];

  assign led_br_c_c2m = led_0_b; // yellow only
  assign led_br_a_c2m = 1'b1;
