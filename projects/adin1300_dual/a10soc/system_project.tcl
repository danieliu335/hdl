...
adi_project adin1300_dual_a10soc
...
set_location_assignment PIN_E5     -to ref_clk_125               ; ## H04  FMCA_HPC_CLK0_M2C_P
set_location_assignment PIN_F5     -to "ref_clk_125(n)"          ; ## H05  FMCA_HPC_CLK0_M2C_N

set_instance_assignment -name IO_STANDARD LVDS -to ref_clk_125
set_instance_assignment -name IO_STANDARD LVDS -to "ref_clk_125(n)"
...
set_location_assignment PIN_E12    -to  gp_clk_a                  ; ## D08 FMCA_HPC_LA01_CC_P - not used in RGMII mode
...
set_instance_assignment -name IO_STANDARD "1.8 V" -to gp_clk_a
...
set_location_assignment PIN_F9     -to  gp_clk_b                  ; ## D20 FMCA_HPC_LA17_CC_P - not used in RGMII mode
...
set_instance_assignment -name IO_STANDARD "1.8 V" -to gp_clk_b
