...
module axi_dac_interpolate_reg(
 ...
 // bus interface
  ...
  reg     [11:0]  up_trigger_config = 12'h0;
  ...
  always @(negedge up_rstn or posedge up_clk) begin
    if (up_rstn == 0) begin
      ...
      if ((up_wreq == 1'b1) && (up_waddr[4:0] == 5'h18)) begin
        up_trigger_config <= up_wdata[11:0];
      end
    end
  end
  ...
  always @(negedge up_rstn or posedge up_clk) begin
    if (up_rstn == 0) begin
      ...
      if (up_rreq == 1'b1) begin
        case (up_raddr[4:0])
          ...
          5'h18: up_rdata <= {20'h0,up_trigger_config};
          default: up_rdata <= 0;
        endcase
      end else begin
        up_rdata <= 32'd0;
   ...
   up_xfer_cntrl #(.DATA_WIDTH(118)) i_xfer_cntrl (
    .up_rstn (up_rstn),
    .up_clk (up_clk),
